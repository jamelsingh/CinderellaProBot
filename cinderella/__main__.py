...
HELP_STRINGS = """
Hey there! My name is [{}](https://telegra.ph/file/ea5f997445581c06aa715.jpg)
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="🔰Help🔰",callback_data="help_back"),InlineKeyboardButton(text="⚜Owner⚜",url="https://t.me/JSINFORobot")]]
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚜️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="🛡Contact Creator",url="https://t.me/JSINFORobot")]]))
        return
